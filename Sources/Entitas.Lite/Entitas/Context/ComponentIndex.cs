...
namespace Entitas
{
 ...
 //       internal static int FindIn(ContextInfo contextInfo)
 //       {
	//		return value;
 //       }
 ...
 //               if (_cachedDefaultIndex < 0)
 //               {
 //                   _cachedDefaultIndex = ComponentIndexGen.NextId();
 //               }
 //               return _cachedDefaultIndex;
 //           }
 //       }
 //   }
    ...
    //internal static class ComponentIndexGen 
    //{
    //    static int IdCnt = 0;
    ...
    internal static class ComponentIndexGen<C> where C : class
    {
		static int IdCnt = 0;
		public static int NextId()
		{
	...
	public class ComponentIndex<C, T> where T : IComponent where C : ContextAttribute
	{
        ...
        public static int value
		{
			...
			{
				if (_cachedIndex < 0)
					_cachedIndex = ComponentIndexGen<C>.NextId();
